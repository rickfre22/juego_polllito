...
while True:
    ...
    # Terreno y carretera
    selfie = pygame.image.load("img/cesped.jpg").convert()
    ventana.blit(selfie, (0, 500))
    selfie = pygame.image.load("img/cesped2.png").convert()
    ventana.blit(selfie, (0,-200)) # Terreno
